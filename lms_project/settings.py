...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'db.sqlite3',  # Tạo tệp SQLite tại thư mục gốc của dự án
    }
}
...
#         'PASSWORD': 'fsa@123456',
#         'HOST': 'hcmuafserver.database.windows.net',  # For example, 'localhost' or an IP address
#         'PORT': '1433',  # Default is usually fine for SQL Server
#         'OPTIONS': {
